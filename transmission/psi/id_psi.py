...
def id_psi_unencrypted(id_list, database_server, options, cid, key_server_qid, agg_server_qid):
    local_max_id, local_min_id = database_server.get_local_max_min_ids(id_list)

    key_server_channel = grpc.insecure_channel('127.0.0.1:50070', options=options)
    ...
    aggregate_server_channel = grpc.insecure_channel('127.0.0.1:50090', options=options)
